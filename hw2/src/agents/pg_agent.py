...
class PGAgent(nn.Module):
    ...
    def update(
        ...
        info: dict = self.actor.update(obs, actions, advantages)#None
    ...
    def _estimate_advantage(
        ...
        if self.critic is None:
            ...
            if self.gae_lambda is None:
                ...
                advantages = q_values - values # None
            else:
                # TODO: implement GAE
