...
\citep{dong2024rlhf}, where the original formulation's two structural
...
is conceptually related to direct policy-gradient estimators in
contextual-bandit settings, where the absence of a bootstrap term
makes within-state action comparisons critic-free
\citep{dudik2014doubly,joachims2018deep}; the multi-agent
counterfactual-baseline construction of Foerster et al.\ is a closer
technical analogue \citep{foerster2018counterfactual}. The
financial-portfolio variant is implicit in early policy-gradient
...
\citep{nair2020awac,zheng2023adaptive}, where the
...
shift, our Phase~2C results suggest its primary apparent effect on this
